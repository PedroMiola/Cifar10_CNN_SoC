...
#define CCS_GP_TYPECONV_H_AC_INT
   ...
   void type_to_gp(const ac_int<Twidth,Tsigned> &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
   ...
   template<int Twidth, bool Tsigned>
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, ac_int<Twidth,Tsigned> *result) {
...
#define CCS_GP_TYPECONV_H_AC_FIXED
   ...
   void type_to_gp(const ac_fixed<Twidth,Ibits,Signed,Qmode,Omode> &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
   ...
   template<int Twidth, int Ibits, bool Signed, ac_q_mode Qmode, ac_o_mode Omode>
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, ac_fixed<Twidth,Ibits,Signed,Qmode,Omode> *result) {
...
#define CCS_GP_TYPECONV_H_AC_FLOAT
   ...
   void type_to_gp(const ac_float<MTbits,MIbits,Ebits,Qmode> &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
   ...
   template<int Twidth, int MTbits, int MIbits, int Ebits, ac_q_mode Qmode>
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, ac_float<MTbits,MIbits,Ebits,Qmode> *result) {
...
#define CCS_GP_TYPECONV_H
   ...
   void ccs_allocate_gp(unsigned int bitlen, tlm_generic_payload *gp) {
   ...
   template<int Twidth>
   void type_to_gp(const sc_uint<Twidth> &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     assert(Twidth==bitlen);
     assert (gp->get_data_length()>0);
     unsigned char *ptr = gp->get_data_ptr();
     unsigned int sbyte = BB/8;
   ...
   template<int Twidth>
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, sc_uint<Twidth> *result) {
     assert(bitlen==Twidth);
     *result = 0; // clear all bits
     unsigned char *    ptr = gp.get_data_ptr();
   ...
   template<int Twidth>
   void type_to_gp(const sc_int<Twidth> &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     assert(Twidth==bitlen);
     assert (gp->get_data_length()>0);
     unsigned char *ptr = gp->get_data_ptr();
     unsigned int sbyte = BB/8;
   ...
   template<int Twidth>
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, sc_int<Twidth> *result) {
     assert(bitlen==Twidth);
     *result = 0; // clear all bits
     unsigned char *    ptr = gp.get_data_ptr();
     unsigned int       len = gp.get_data_length();
   ...
   void type_to_gp(const unsigned long long &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<64,false> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => UNSIGNED LONG LONG
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, unsigned long long *result) {
     assert(bitlen==64);
     *result = 0; // clear all bits
   ...
   void type_to_gp(const long long &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<64,true> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => LONG LONG
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, long long *result) {
     assert(bitlen==64);
     *result = 0; // clear all bits
   ...
   void type_to_gp(const unsigned long &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
   ...
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, unsigned long *result) {
     assert(sizeof(long)==4); // assume 32bit compilation
     assert(bitlen==32);
     *result = 0; // clear all bits
   ...
   // --------------------------------- LONG
   // LONG => GenericPayload
   void type_to_gp(const long &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     assert(sizeof(long)==4); // assume 32bit compilation
   ...
   // GenericPayload => LONG
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, long *result) {
     assert(sizeof(long)==4); // assume 32bit compilation
     assert(bitlen==32);
     *result = 0; // clear all bits
   ...
   void type_to_gp(const unsigned int &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<32,false> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => UNSIGNED INT
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, unsigned int *result) {
     assert(bitlen==32);
     *result = 0; // clear all bits
     ac_int<32,false> tmp_result;
     gp_to_type(gp,bitlen,BB,&tmp_result);
   ...
   // --------------------------------- INT
   // INT => GenericPayload
   void type_to_gp(const int &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<32,true> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => INT
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, int *result) {
     assert(bitlen==32);
     *result = 0; // clear all bits
     ac_int<32,true> tmp_result;
     gp_to_type(gp,bitlen,BB,&tmp_result);
   ...
   void type_to_gp(const unsigned short &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<16,false> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => UNSIGNED SHORT
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, unsigned short *result) {
     assert(bitlen==16);
     *result = 0; // clear all bits
   ...
   void type_to_gp(const short &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<16,true> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => SHORT
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, short *result) {
     assert(bitlen==16);
     *result = 0; // clear all bits
   ...
   void type_to_gp(const unsigned char &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<8,false> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => UNSIGNED CHAR
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, unsigned char *result) {
     assert(bitlen==8);
     *result = 0; // clear all bits
   ...
   // --------------------------------- CHAR
   // CHAR => GenericPayload
   void type_to_gp(const char &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     ac_int<8,true> tmp_in = in;
     type_to_gp(tmp_in,bitlen,BB,gp);
   }
   
   // GenericPayload => CHAR
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, char *result) {
     assert(bitlen==8);
     *result = 0; // clear all bits
   ...
   // --------------------------------- BOOL
   // BOOL => GenericPayload
   void type_to_gp(const bool &in, unsigned int bitlen, unsigned int BB, tlm_generic_payload *gp) {
     assert (gp->get_data_length()>0);
     unsigned char *ptr = gp->get_data_ptr();
   ...
   // GenericPayload => BOOL
   void gp_to_type(const tlm_generic_payload &gp, unsigned int bitlen, unsigned int BB, bool *result) {
     assert(bitlen==1);
     unsigned char *    ptr = gp.get_data_ptr();
     unsigned int       len = gp.get_data_length();
